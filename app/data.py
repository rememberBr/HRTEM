...
class myAugmentation(object):
	...
	"""
	def __init__(self, train_path="scaleimages/train/images/", label_path="scaleimages/train/label/", merge_path="scaleimages/train/merge", aug_merge_path="scaleimages/train/aug_merge", aug_train_path="scaleimages/train/aug_train", aug_label_path="scaleimages/train/aug_label", img_type="png"):
		"""
	...
	def splitTransform(self):
		...
		path_merge = "scaleimages/train/deform_norm2"
		path_train = "scaleimages/train/images/"
		path_label = "scaleimages/train/label/"
...
class dataProcess(object):
	def __init__(self, out_rows, out_cols, data_path = r"data/pow10spin/train/images", label_path = r"data/pow10spin/train/label", test_path = r"data/pow10spin/test", npy_path = "npydata", img_type = "png"):
        # 数据处理类，初始化
